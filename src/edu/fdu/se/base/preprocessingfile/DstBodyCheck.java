...
//                    s1 = Global.util.getLineNumber(Global.util.getSrcCu(compareResult),srcBody.getBodyDeclaration().getStartPosition());
//                    e1 = Global.util.getLineNumber(Global.util.getSrcCu(compareResult),
//                            srcBody.getBodyDeclaration().getStartPosition() + srcBody.getBodyDeclaration().getLength() - 1);

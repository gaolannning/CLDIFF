...
import edu.fdu.se.base.preprocessingfile.PreprocessUtil;
...
//                System.out.println(cod.toString());
                    ...
                    compareCache.setBodySrcNodeMap(srcBody, PreprocessedTempData.BODY_SAME_REMOVE);
                    new TypeNodesTraversalJava().traverseTypeDeclarationSetVisited(compareCache, (TypeDeclaration) srcBody.getBodyDeclaration(), prefixClassName);
                    return 1;
                } else {
                    compareCache.setBodySrcNodeMap(srcBody, PreprocessedTempData.BODY_DIFFERENT_RETAIN);
                    return 2;
...
//                    s2 = compareResult.getDstCu().getLineNumber(ed.getStartPosition() + ed.getLength() - 1);
//                    e2 = compareResult.getDstCu().getLineNumber(ed.getStartPosition() + ed.getLength() - 1);
                    s1 = Global.util.getLineNumber(Global.util.getSrcCu(compareResult),((ASTNode)srcBody.getBodyDeclaration()).getStartPosition());
                    e1 = Global.util.getLineNumber(Global.util.getSrcCu(compareResult),
                            ((ASTNode)srcBody.getBodyDeclaration()).getStartPosition() + ((ASTNode)srcBody.getBodyDeclaration()).getLength() - 1);
                    s2 = Global.util.getLineNumber(Global.util.getDstCu(compareResult),ed.getStartPosition() + ed.getLength() - 1);
                    e2 = Global.util.getLineNumber(Global.util.getDstCu(compareResult),ed.getStartPosition() + ed.getLength() - 1);
